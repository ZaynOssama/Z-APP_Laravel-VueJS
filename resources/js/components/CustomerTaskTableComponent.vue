...
import swal from 'sweetalert';
    ...
    export default {
        ...
        methods: {
            ...
            // }
            getTasks() {
                axios.get('my-tasks-data').then(res => {
                    this.tasks = res.data;
            ...
            createTask() {
                axios.post('my-new-task', this.dataTask).then(res => {
                    this.dataTask ={title: '', description: '',}
                    this.getTasks()
            ...
            openEditTask(task_data) {
                this.dataTask ={title: task_data.title, description: task_data.description}
            ...
            editTask() {
                axios.put('edit-my-task/'+this.idTask, this.dataTask).then(res => {
                    this.idTask = ''
                    this.getTasks()
                    this.modalShow = false
            ...
            openDeleteTask(task_data) {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        axios.delete('delete-my-task/'+task_data.id).then(res => {
                            this.getTasks()
